...
export const crewWithAgentsResponseSchema = t.Object({
	agents: t.Array(
		t.Object({
...
// Union schemas for nullable responses
export const crewResponseUnionSchema = t.Union([crewResponseSchema, t.Null()]);
export const crewWithAgentsResponseUnionSchema = t.Union([crewWithAgentsResponseSchema, t.Null()]);
